...
const PoliciesScreen: React.FC = () => {
    ...
    return (
        <ScrollView style={styles.container}>
            <Text style={[styles.sectionHeader, { color: state.mainColor }]}>Polityka Prywatności</Text>
                    ...
                    <MarkedList counterRenderer={point}>
                        ...
                        <View style={{ flexShrink: 1 }}>
                            ...
                            <MarkedList counterRenderer={square}>
                                <Text style={styles.listElement}>Prezentacja listy głosicieli</Text>
                                <Text style={styles.listElement}>Wyświetlanie imienia i nazwiska danej osoby na karcie terenu</Text>
                                <Text style={styles.listElement}>Prezentacja list grup służby</Text>
                            </MarkedList>
                        </View>
                        <View style={{ flexShrink: 1 }}>
            ...
            <Text style={[styles.sectionHeader, { color: state.mainColor }]}>Klauzula RODO</Text>
